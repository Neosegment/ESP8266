...
This file writes out the first 12 digits of number Pi on 6 Neosegment modules using pin D5 of NodeMCU board

*/

#define nDigits 12 // Number of digits you have connected (one Neosegment module consists of 2 digits)
#define PIN D5 // Pin that Neosegment modules are connected to
